        ...
        {orders.slice(0, 5).map((order) => (
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium text-sm">{order.vehicle.brand} {order.vehicle.model}</p>
                <p className="text-xs text-muted-foreground">{order.vehicle.plate} • {order.client.name}</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <Badge className={cn(
                ...
                order.status === 'listo' ? 'text-primary-foreground' : 'text-primary-foreground'
              )}>
