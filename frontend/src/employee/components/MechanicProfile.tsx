            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center py-2 border-b border-border">
                ...
                <span className="font-medium">
                  {/* MEC-{currentMechanic.id.padStart(3, "0")} */}
                </span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-border">
              ...
              <div className="flex justify-between items-center py-2">
                ...
                <Badge
                  variant="secondary"
                  className="bg-status-ready/10 text-status-ready border-0"
                >
                  Activo
                </Badge>
              </div>
      ...
      <div className="px-4 mt-4">
        <Card>
          <CardContent className="p-2">
            ...
            <button onClick={handleLogout} className="w-full flex items-center justify-between p-3 hover:bg-muted/50 rounded-lg transition-colors text-status-error">
              <div className="flex items-center gap-3">
